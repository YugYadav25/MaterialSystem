    ...
    return (
        <div className="relative flex min-h-screen w-full flex-col group/design-root overflow-x-hidden bg-background-light dark:bg-background-dark text-[#111816] dark:text-white transition-colors duration-200">
            <div className="layout-container flex h-full grow flex-col">
                {/* Navigation Bar */}
                <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-[#dbe6e2] dark:border-[#2a3c36] bg-white dark:bg-background-dark px-10 py-3 sticky top-0 z-50">
                ...
                <main className="flex flex-col flex-1">
                    ...
                    <section className="flex flex-col items-center justify-center bg-white dark:bg-background-dark py-12 @container">
                        <div className="max-w-[1200px] w-full px-10 flex flex-col lg:flex-row items-center gap-12">
                    ...
                    {/* Section Header */}
                    <section className="max-w-[1200px] mx-auto w-full px-10 pt-20">
                    ...
                    <section className="max-w-[1200px] mx-auto w-full px-10 py-10">
                    ...
                    {/* CTA Section */}
                    <section className="max-w-[1200px] mx-auto w-full px-10 py-20 mb-20">
